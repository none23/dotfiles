...
let s:N1   = [ '#000000' , '#ff5500' , 17  , 190 ]
let s:N2   = [ '#ffffff' , '#202020' , 255 , 238 ]
let s:N3   = [ '#cccccc' , '#111111' , 85  , 234 ]
