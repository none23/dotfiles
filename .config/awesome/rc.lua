...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox:setup {
    ...
    s.mytasklist,
    {
      ...
      {
        {
          awful.widget.watch("zsh -c " .. scripts_path .. "iploc", 10),
      ...
      {
        {
          awful.widget.watch("zsh -c " .. scripts_path .. "ipext", 10),
          bg = beautiful.bg_normal,
          fg = beautiful.primary_muted,
          widget = wibox.container.background,
        },
      ...
      {
        {
          ...
          {
            awful.widget.watch("zsh -c " .. scripts_path .. "cpu", 5),
            left = 2,
            right = 4,
            widget = wibox.container.margin,
          },
      ...
      {
        {
          ...
          {
            awful.widget.watch("zsh -c " .. scripts_path .. "volp", 60),
            left = 1,
            right = 4,
            widget = wibox.container.margin,
          },
      ...
      {
        {
          ...
          {
            awful.widget.watch("zsh -c " .. scripts_path .. "pwrp", 30),
            left = 1,
            right = 4,
            widget = wibox.container.margin,
          },
...
globalkeys = awful.util.table.join(
  awful.key({ Super        }, "h", function () awful.client.focus.global_bydirection("left") if client.focus then client.focus:raise() end end, { description = "focus by direction left", group ="client"}),
  awful.key({ Super        }, "j", function () awful.client.focus.global_bydirection("down") if client.focus then client.focus:raise() end end, {description ="focus by direction down", group ="client"}),
  awful.key({ Super        }, "k", function () awful.client.focus.global_bydirection("up") if client.focus then client.focus:raise() end end, {description ="focus by direction up", group ="client"}),
  awful.key({ Super        }, "l", function () awful.client.focus.global_bydirection("right") if client.focus then client.focus:raise() end end, {description ="focus by direction right", group ="client"}),
  awful.key({ Super, Shift }, "h", function () awful.client.swap.global_bydirection("left")  end, {description ="swap by direction left", group ="client"} ),
  awful.key({ Super, Shift }, "j", function () awful.client.swap.global_bydirection("down")  end, {description ="swap by direction down", group ="client"}  ),
  awful.key({ Super, Shift }, "k", function () awful.client.swap.global_bydirection("up")    end, {description ="swap by direction up", group ="client"}  ),
  awful.key({ Super, Shift }, "l", function () awful.client.swap.global_bydirection("right") end, {description ="swap by direction right", group ="client"} ),
  awful.key({ Super        }, "w", function () awful.client.focus.byidx(1) if client.focus then client.focus:raise() end                    end, { description ="focus next", group ="client" }),
  awful.key({ Super, Cntrl }, "w", function () awful.client.cycle({clockwise=true})                                                         end, { description ="focus next (cycle)", group ="client" }),
  awful.key({ Super        }, "b", function () awful.client.focus.history.previous() if client.focus then client.focus:raise() end          end, { description = "go back", group = "client"}),
  awful.key({ Super, Cntrl }, "a", function () local c = awful.client.restore() if c then client.focus = c c:raise() end end, {description = "restore minimized", group = "client", group ="client" }),
  ...
  awful.key({ Super, Cntrl }, "Down",   function () awful.tag.incnmaster(-1)                                                                     end ),
  awful.key({ Super, Cntrl }, "Up",     function () awful.tag.incnmaster(1)                                                                      end ),
  awful.key({ Super, Cntrl }, "Right",  function () awful.tag.incmwfact(0.01)                                                                    end ),
  awful.key({ Super, Cntrl }, "Left",   function () awful.tag.incmwfact(-0.01)                                                                   end ),
  awful.key({ Super        }, "s",      function () awful.screen.focus_relative(1) if client.focus then client.focus:raise() end                 end, {description = "focus the next screen", group = "screen"}),
  awful.key({ Super,       }, "F1",     hotkeys_popup.show_help,                                                                                 {description="show help", group="awesome"}),
  awful.key({ Super        }, "F10",    function () awful.spawn("touchpad_ctrl")                                                            end ),
  awful.key({ Super        }, "F12",    function () awful.spawn("xscreensaver-command -lock")                                               end ),
  ...
  awful.key({ }, "XF86AudioMute",       function () awful.spawn("amixer -q set Master playback toggle") end ),
  awful.key({ Super, Cntrl }, "r",      awesome.restart, {description = "reload awesome", group = "awesome"}),
  awful.key({ Super, Cntrl }, "q",      awesome.quit, {description = "quit awesome", group = "awesome"}),
  awful.key({ Super        }, "period", function () awful.tag.incncol(1)                                                                         end, {description ="increace n col"} ),
  awful.key({ Super        }, "comma",  function () awful.tag.incncol(-1)                                                                        end, {description ="decreace n col"} ),
  ...
  awful.key({ Super, Cntrl }, "h",      function () awful.tag.incncol( 1, nil, true)    end, {description = "increase the number of columns", group = "layout"}),
  awful.key({ Super, Cntrl }, "l",      function () awful.tag.incncol(-1, nil, true)    end, {description = "decrease the number of columns", group = "layout"}),
  awful.key({ Super        }, "Return", function () awful.spawn("konsole -e zsh")                                                           end, {description = "open a terminal", group = "launcher"}),
  awful.key({ Hyper        }, "1",      function () awful.spawn("chromium")                                                                 end ),
  awful.key({ Hyper, Cntrl }, "1",      function () awful.spawn("tor-browser-en")                                                           end ),
  awful.key({ Hyper        }, "2",      function () awful.spawn("firefox")                                                                  end ),
  awful.key({ Hyper, Cntrl }, "2",      function () awful.spawn("chromium --kiosk")                                                         end ),
  awful.key({ Hyper        }, "3",      function () awful.spawn("atom")                                                                     end ),
  awful.key({ Hyper, Cntrl }, "3",      function () awful.spawn("blender")                                                                  end ),
  awful.key({ Hyper        }, "4",      function () awful.spawn("inkscape")                                                                 end ),
  awful.key({ Hyper        }, "5",      function () awful.spawn("gimp")                                                                     end ),
  awful.key({ Hyper        }, "8",      function () awful.spawn("transset-df 1")                                                            end ),
  awful.key({ Hyper, Cntrl }, "8",      function () awful.spawn("transset-df .8")                                                           end ),
  awful.key({ Hyper        }, "9",      function () awful.spawn("transset-df .65")                                                          end ),
  awful.key({ Hyper, Cntrl }, "9",      function () awful.spawn("transset-df .4")                                                           end ),
  awful.key({ Super        }, "x",      function () awful.screen.focused().mypromptbox:run() end, {description = "show the menubar", group = "launcher"})
)
...
clientkeys = gears.table.join(
  ...
  awful.key({ Super }, "u",      function (c) c.below = not c.below                                                                      end, {description = "toggle keep below", group = "client"}),
  ...
  awful.key({ Super }, "backslash", function (c) c.maximized_vertical = not c.maximized_vertical c:raise() end , {description = "(un)maximize vertically", group = "client"}),
  awful.key({ Super }, "minus", function (c) c.maximized_horizontal = not c.maximized_horizontal c:raise() end , {description = "(un)maximize horizontally", group = "client"})
)
...
for i = 1, 9 do
  globalkeys = awful.util.table.join(
    ...
    awful.key( { Super, Shift, Cntrl }, "#"..i + 9,
      ...
      { description = "toggle tag #"..i.." for all clients of current tag", group = "tag" }
    )
  )
end
