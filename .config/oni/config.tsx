...
export const configuration = {
  ...
  'language.html.languageServer.command':
    '/opt/oni/resources/app/node_modules/vscode-html-languageserver-bin/htmlServerMain.js',
  'language.html.languageServer.arguments': ['--stdio'],
  'language.go.languageServer.command': 'go-langserver',
  'language.go.textMateGrammar':
    '/opt/oni/resources/app/extensions/go/syntaxes/go.json',
  'language.vue.textMateGrammar':
    '/opt/oni/resources/app/extensions/vue/syntaxes/vue.json',
  ...
  'language.css.languageServer.command':
    '/opt/oni/resources/app/node_modules/vscode-css-languageserver-bin/cssServerMain.js',
  'language.css.languageServer.arguments': ['--stdio'],
  'language.css.textMateGrammar':
    '/opt/oni/resources/app/extensions/css/syntaxes/css.tmLanguage.json',
  'language.css.tokenRegex': '[$_a-zA-Z0-9-]',
  'language.elixir.textMateGrammar': {
    '.ex':
      '/opt/oni/resources/app/extensions/elixir/syntaxes/elixir.tmLanguage.json',
    '.exs':
      '/opt/oni/resources/app/extensions/elixir/syntaxes/elixir.tmLanguage.json',
    '.eex':
      '/opt/oni/resources/app/extensions/elixir/syntaxes/eex.tmLanguage.json',
    '.html.eex':
      '/opt/oni/resources/app/extensions/elixir/syntaxes/html(eex).tmLanguage.json',
  },
  'language.less.languageServer.command':
    '/opt/oni/resources/app/node_modules/vscode-css-languageserver-bin/cssServerMain.js',
  'language.less.languageServer.arguments': ['--stdio'],
  'language.less.textMateGrammar':
    '/opt/oni/resources/app/extensions/less/syntaxes/less.tmLanguage.json',
  'language.less.tokenRegex': '[$_a-zA-Z0-9-]',
  'language.scss.languageServer.command':
    '/opt/oni/resources/app/node_modules/vscode-css-languageserver-bin/cssServerMain.js',
  'language.scss.languageServer.arguments': ['--stdio'],
  'language.scss.textMateGrammar':
    '/opt/oni/resources/app/extensions/scss/syntaxes/scss.json',
  'language.scss.tokenRegex': '[$_a-zA-Z0-9-]',
  'language.reason.languageServer.command':
    '/opt/oni/resources/app/node_modules/ocaml-language-server/bin/server/index.js',
  ...
  'language.reason.textMateGrammar':
    '/opt/oni/resources/app/extensions/reason/syntaxes/reason.json',
  'language.ocaml.languageServer.command':
    '/opt/oni/resources/app/node_modules/ocaml-language-server/bin/server/index.js',
  ...
  'ui.fontFamily':
    "'xos4 Terminus', 'Inconsolata for Powerline', 'monospace', monospace, BlinkMacSystemFont, 'Lucida Grande', 'Segoe UI', Ubuntu, Cantarell, sans-serif",
  'ui.fontSize': '12px',
