...
" search with '/', then cs, <Esc>, then n.n.n. for reviewing and replacing all
" matches found
vnoremap <silent> s //e<C-r>=&selection=='exclusive'?'+1':''<CR><CR>
    \:<C-u>call histdel('search',-1)<Bar>let @/=histget('search',-1)<CR>gv
omap s :normal vs<CR>

" copy/paste to system clipboard with <Space>y , <Space>d , <Space>p
vmap <Leader>y "+y
vmap <Leader>d "+d
vmap <Leader>p "+p
vmap <Leader>P "+P
...
nmap  ,sn <plug>(signiey-next-hunk)
